...
- `claude_pass`: Claude artifact review PASS attestation has closed the pending follow-up. Self-check requires `claude_review_status=pass`, `pending_closed=true`, and `follow_up_required=[]`.
